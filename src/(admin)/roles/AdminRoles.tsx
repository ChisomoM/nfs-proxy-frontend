  ...
  return (
    <PageTransition className="space-y-8">
      <PageHeader
        ...
        subtitle="Manage global roles and their permission sets."
        action={
                  ...
                  <TableRow key={role.id}>
                    ...
                    <TableCell>
                      <Badge variant={role.is_global ? 'default' : 'secondary'}>
                        {role.is_global ? 'Global' : role.app_id ?? 'App'}
                      </Badge>
                    </TableCell>
        ...
        <DialogContent className="max-w-2xl bg-white p-0 overflow-hidden border-none shadow-2xl">
          ...
          <div className="px-8 py-6 border-b border-gray-200">
            ...
            <p className="font-sans text-text-sm text-gray-600 mt-1">
              {editingRole
                ? 'Update the name for this global role.'
                : 'Define a new global role with specific permissions.'}
            </p>
          </div>
                ...
                {!editingRole && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
                    ...
                    <p className="text-xs mt-1 text-blue-700">
                      This role applies across all apps. Select the permissions it should grant.
                    </p>
                  </div>
                )}
